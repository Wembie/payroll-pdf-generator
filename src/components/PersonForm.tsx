...
export const PersonForm: React.FC<Props> = ({
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-card dark:shadow-none border border-slate-100 dark:border-slate-700 p-4 sm:p-6 animate-fade-in">
